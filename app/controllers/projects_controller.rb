class ProjectsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to user_path(current_user), notice: 'Project was successfully updated.' }
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :description, :job_type, :languages)
    end
end
